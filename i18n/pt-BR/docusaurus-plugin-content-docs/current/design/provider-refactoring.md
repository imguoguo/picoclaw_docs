...
2. **Prefixo de protocolo**: Usa formato `protocol/model_name`, ex.: `openai/gpt-5.4`, `anthropic/claude-sonnet-4.6`
...
type ModelConfig struct {
    ...
    Model     string `json:"model"`       // protocol/model, ex.: openai/gpt-5.4
