...
- [Primeiros Passos](./getting-started) — configure e execute seu primeiro chat
- [Configuração](./configuration) — referência completa de configuração
- [Canais de Chat](./channels) — conecte ao Telegram, Discord e mais
